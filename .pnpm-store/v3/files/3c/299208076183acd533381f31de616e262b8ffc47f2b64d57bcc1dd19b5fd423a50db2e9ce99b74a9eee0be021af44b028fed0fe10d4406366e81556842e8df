...
for(n=Object.getOwnPropertySymbols(e);o<n.length;o++)t.indexOf(n[o])<0&&(r[n[o]]=e[n[o]])}return r}function __awaiter(i,a,c,u){return new(c||(c=Promise))(function(e,t){function r(e){try{o(u.next(e))}catch(e){t(e)}}function n(e){try{o(u.throw(e))}catch(e){t(e)}}function o(t){t.done?e(t.value):new c(function(e){e(t.value)}).then(r,n)}o((u=u.apply(i,a||[])).next())})}function __generator(r,n){var o,i,a,e,c={label:0,sent:function(){if(1&a[0])throw a[1]
return a[1]},trys:[],ops:[]}
...
return{value:t[0]?t[1]:void 0,done:!0}}([t,e])}}}var root,validate=function(e){},pluginFactory=function(e){return{config:e,validate:validate,create:function(e){validate([[e.onStoreCreated&&"function"!=typeof e.onStoreCreated,"Plugin onStoreCreated must be a function"],[e.onModel&&"function"!=typeof e.onModel,"Plugin onModel must be a function"],[e.middleware&&"function"!=typeof e.middleware,"Plugin middleware must be a function"]]),e.onInit&&e.onInit.call(this)
var t={}
...
r=!1,s()
var e=c.indexOf(t)
c.splice(e,1)}}}function l(e){if(!isPlainObject(e))throw Error("Actions must be plain objects. Use custom middleware for async actions.")
...
try{u=!0,i=o(i,e)}finally{u=!1}for(var t=a=c,r=0;r<t.length;r++){(0,t[r])()}return e}return l({type:ActionTypes.INIT}),(n={dispatch:l,subscribe:f,getState:d,replaceReducer:function(e){if("function"!=typeof e)throw Error("Expected the nextReducer to be a function.")
...
if(void 0===t(void 0,{type:ActionTypes.PROBE_UNKNOWN_ACTION()}))throw Error('Reducer "'+e+"\" returned undefined when probed with a random type. Don't try to handle "+ActionTypes.INIT+' or other actions in "redux/*" namespace. They are considered private. Instead, you must return the current state for any unknown actions, unless it is undefined, in which case you must return the initial state, regardless of the action type. The initial state may not be undefined, but can be null.')})}function combineReducers(e){for(var t=Object.keys(e),s={},r=0;r<t.length;r++){var n=t[r]
"function"==typeof e[n]&&(s[n]=e[n])}var d,f=Object.keys(s)
try{assertReducerShape(s)}catch(e){d=e}return function(e,t){if(void 0===e&&(e={}),d)throw d
for(var r=!1,n={},o=0;o<f.length;o++){var i=f[o],a=e[i],c=(0,s[i])(a,t)
if(void 0===c){var u=getUndefinedStateErrorMessage(i,t)
throw Error(u)}n[i]=c,r=r||c!==a}return r?n:e}}function bindActionCreator(e,t){return function(){return t(e.apply(this,arguments))}}function bindActionCreators(e,t){if("function"==typeof e)return bindActionCreator(e,t)
...
"function"==typeof a&&(n[i]=bindActionCreator(a,t))}return n}function _defineProperty(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function _objectSpread(t){for(var e=1;e<arguments.length;e++){var r=null!=arguments[e]?arguments[e]:{},n=Object.keys(r)
"function"==typeof Object.getOwnPropertySymbols&&(n=n.concat(Object.getOwnPropertySymbols(r).filter(function(e){return Object.getOwnPropertyDescriptor(r,e).enumerable}))),n.forEach(function(e){_defineProperty(t,e,r[e])})}return t}function compose(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
...
return _objectSpread({},e,{dispatch:t=compose.apply(void 0,n)(e.dispatch)})}}}var Redux=Object.freeze({createStore:createStore,combineReducers:combineReducers,bindActionCreators:bindActionCreators,applyMiddleware:applyMiddleware,compose:compose,__DO_NOT_USE__ActionTypes:ActionTypes}),isListener=function(e){return-1<e.indexOf("/")},composeEnhancersWithDevtools=function(e){void 0===e&&(e={})
...
function createRedux(e){var u=this,t=e.redux,r=e.models,n=t.combineReducers||combineReducers,o=t.createStore||createStore,i=void 0!==t.initialState?t.initialState:{}
this.reducers=t.reducers,this.mergeReducers=function(e){return void 0===e&&(e={}),u.reducers=__assign({},u.reducers,e),Object.keys(u.reducers).length?n(u.reducers):function(e){return e}},this.createModelReducer=function(r){for(var n=r.baseReducer,o={},e=0,t=Object.keys(r.reducers||{});e<t.length;e++){var i=t[e],a=isListener(i)?i:r.name+"/"+i
...
var s=this.createRootReducer(t.rootReducers),d=applyMiddleware.apply(Redux,t.middlewares),f=composeEnhancersWithDevtools(t.devtoolOptions).apply(void 0,t.enhancers.concat([d]))
return this.store=o(s,i,f),this}var corePlugins=[dispatchPlugin,effectsPlugin],Rematch=function(){function e(e){var t=this
...
o[e]&&t(o[e])}},e.prototype.getModels=function(t){return Object.keys(t).map(function(e){return __assign({name:e},t[e],{reducers:t[e].reducers||{}})})},e.prototype.addModel=function(t){validate([[!t,"model config is required"],["string"!=typeof t.name,'model "name" [string] is required'],[void 0===t.state&&void 0===t.baseReducer,'model "state" is required'],[void 0!==t.baseReducer&&"function"!=typeof t.baseReducer,'model "baseReducer" must be a function']]),this.forEachPlugin("onModel",function(e){return e(t)})},e.prototype.init=function(){var t=this
this.models=this.getModels(this.config.models)
for(var e=0,r=this.models;e<r.length;e++){this.addModel(r[e])}var n=createRedux.call(this,{redux:this.config.redux,models:this.models}),o=__assign({name:this.config.name},n.store,{model:function(e){t.addModel(e),n.mergeReducers(n.createModelReducer(e)),n.store.replaceReducer(n.createRootReducer(t.config.redux.rootReducers)),n.store.dispatch({type:"@@redux/REPLACE "})}})
return this.forEachPlugin("onStoreCreated",function(e){var t=e(o)
t&&Object.keys(t||{}).forEach(function(e){o[e]=t[e]})}),o},e}(),deprecate=function(e){console.warn(e)},merge=function(e,t){return t?__assign({},t,e||{}):e||{}},mergeConfig=function(e){for(var t=__assign({name:e.name,models:{},plugins:[]},e,{redux:__assign({reducers:{},rootReducers:{},enhancers:[],middlewares:[]},e.redux,{devtoolOptions:__assign({name:e.name},e.redux&&e.redux.devtoolOptions?e.redux.devtoolOptions:{})})}),r=0,n=t.plugins;r<n.length;r++){var o=n[r]
if(o.config){var i=merge(t.models,o.config.models)
t.models=i,t.plugins=t.plugins.concat(o.config.plugins||[]),o.config.redux&&(t.redux.initialState=merge(t.redux.initialState,o.config.redux.initialState),t.redux.reducers=merge(t.redux.reducers,o.config.redux.reducers),t.redux.rootReducers=merge(t.redux.rootReducers,o.config.redux.reducers),t.redux.enhancers=t.redux.enhancers.concat(o.config.redux.enhancers||[]),t.redux.middlewares=t.redux.middlewares.concat(o.config.redux.middlewares||[]),t.redux.combineReducers=t.redux.combineReducers||o.config.redux.combineReducers,t.redux.createStore=t.redux.createStore||o.config.redux.createStore)}}return t},getState=function(){deprecate("global getState has been removed in @rematch/core 1.0.0-beta.3.\n\tSee https://github.com/rematch/rematch/blob/master/CHANGELOG.md#100-beta3---2018-06-23 for details.\n\tFor a quick fix, import and use store.getState.")},dispatch=function(){deprecate("global dispatch has been removed in @rematch/core 1.0.0-beta.3.\n\tSee https://github.com/rematch/rematch/blob/master/CHANGELOG.md#100-beta3---2018-06-23 for details.\n\tFor a quick fix, import and use store.dispatch.")}
function createModel(e){return e}var count=0,init=function(e){void 0===e&&(e={})
var t=e.name||""+count
count+=1
var r=mergeConfig(__assign({},e,{name:t}))
return new Rematch(r).init()},index={init:init}
exports.getState=getState,exports.dispatch=dispatch,exports.createModel=createModel,exports.init=init,exports.default=index
